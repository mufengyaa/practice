...
namespace bit
{
    ...
    public:
        ...
        myvector(myvector<T> &&v) noexcept // 移动构造
            : _start(nullptr), _finish(nullptr), _endOfStorage(nullptr)
        {
            cout << "移动构造" << endl;
            swap(v);
        ...
        // myvector(const initializer_list<T> &l)  //初始化列表构造(传入引用)
        //     : _start(nullptr), _finish(nullptr), _endOfStorage(nullptr)
        // {
        //     cout << "深拷贝" << endl;
        //     reserve(l.size());
        ...
        //     }
        // }
        myvector(initializer_list<T> l) // 初始化列表构造
            : _start(nullptr), _finish(nullptr), _endOfStorage(nullptr)
        {
            // cout << "深拷贝" << endl;
            reserve(l.size());
        ...
        myvector<T> &operator=(myvector<T> &&v) noexcept // 移动赋值
        {
            cout << "移动赋值" << endl;
            swap(v);
            return *this;
        ...
        // myvector<T> &operator=(const initializer_list<T> &l) // 初始化列表赋值(传入引用)
        // {
        //     cout << "深拷贝" << endl;
        //     myvector<T> tmp(l);
        //     swap(tmp);
        //     return *this;
        // }
        myvector<T> &operator=(initializer_list<T> l) // 初始化列表赋值
        {
            cout << "深拷贝" << endl;
            myvector<T> tmp(l);
            swap(tmp);
