...
// void test1() {
//     my_hash_table::HashTable<int, int> hs(3);
//     hs.Insert(make_pair(-1, 2));
//     hs.Insert(make_pair(41, 2));
//     hs.Print();
//     hs.Insert(make_pair(15, 2));
//     hs.Insert(make_pair(2, 2));
//     hs.Insert(make_pair(11, 2));
//     hs.Print();
//     if (!hs.Empty()) {
//         hs.Erase(11);
//     }
